...
class ChartOfAccountsSeeder extends Seeder
{
    ...
    private function getCompleteChartOfAccounts(): array
    {
        ...
        $pucData = [
            ...
            ['11100501', 'NOMBRE DEL BANCO NUMERO Y TIPO DE CUENTA', 5],
            ['1120', 'CUENTAS DE AHORRO', 3],
            ['112005', 'BANCOS NACIONALES', 4],
            ['11200501', 'NOMBRE DEL BANCO NUMERO Y TIPO DE CUENTA', 5],
            ['1125', 'FONDOS', 3],
            ...
            ['139905', 'PROPIETARIOS Y/O RESIDENTES', 4],
            ...
            ['23353520', 'PISCINAS', 5],
            ['23353525', 'PARQUEADEROS', 5],
            ['23353530', 'PLANTA ELÉCTRICA (INCLUYE COMBUSTIBLES Y LUBRICANTES)', 5],
            ['23353535', 'TANQUES DE AGUA POTABLE', 5],
            ['23353540', 'CAJAS DE AGUAS NEGRAS', 5],
            ['23353545', 'EQUIPO DE CÓMPUTO', 5],
            ['23353550', 'EQUIPO DE OFICINA', 5],
            ['23353555', 'CITOFONOS', 5],
            ['23353560', 'CCTV', 5],
            ['23353565', 'REPARACIONES LOCATIVAS', 5],
            ['23353570', 'CERRAJERÍA Y SIMILARES', 5],
            ['23353575', 'ELÉCTRICOS (REDES-BOMBILLOS)', 5],
            ['23353580', 'EXTINTORES', 5],
            ['23353585', 'FUMIGACIÓN Y ROEDORES', 5],
            ['23353590', 'MANTENIMIENTO CUBIERTAS Y FACHADAS', 5],
            ['233545', 'TRANSPORTES, FLETES Y ACARREOS', 4],
            ['233550', 'SERVICIOS PUBLICOS', 4],
            ['233555', 'SEGUROS', 4],
            ['233570', 'CHEQUES GIRADOS PENDIENTES DE COBRO', 4],
            ['233595', 'OTROS', 4],
            ...
            ['2540', 'INDEMNIZACIONES LABORALES', 3],
            ['27', 'DIFERIDOS', 2],
            ['2705', 'INGRESOS RECIBIDOS POR ANTICIPADO', 3],
            ['270505', 'CUOTAS DE ADMINISTRACIÓN', 4],
            ['270510', 'CUOTAS EXTRAORDINARIAS', 4],
            ['270595', 'OTROS', 4],
            ['28', 'OTROS PASIVOS', 2],
            ['2810', 'DEPOSITOS RECIBIDOS', 3],
            ['281005', 'PARA OBRAS E INVERSIONES', 4],
            ['28100505', 'PARA OBRA DE FACHADAS', 5],
            ['281035', 'FONDO DE IMPREVISTOS', 3],
            ['2815', 'INGRESOS RECIBIDOS PARA TERCEROS', 3],
            ['281505', 'VALORES RECIBIDOS PARA TERCEROS', 4],
            ['2820', 'CONSIGNACIONES SIN IDENTIFICAR', 3],
            ['2825', 'RETENCIONES A TERCEROS SOBRE CONTRATOS', 3],
            ...
            ['417050', 'POR REINTEGRO PROVISIONES', 4],
            ['417060', 'REINTEGRO DE OTROS COSTOS Y GASTOS', 4],
            ...
            ['417090', 'INGRESOS DE EJERCICIOS ANTERIORES', 4],
            ['417095', 'INGRESOS FINANCIEROS', 4],
            ...
            ['513535', 'TELEFONO', 4],
            ['513540', 'TELEVISIÓN E INTERNET', 4],
            ['513545', 'CORREO, PORTES Y TELEGRAMAS', 4],
            ['513555', 'GAS', 4],
