  ...
  const tourSteps: TourStep[] = [
    {
      ...
      description: 'Te guiaremos para configurar completamente el Sistema SIA. Crearemos el programa "Ingeniería de Sistemas" siguiendo el Flujo 1: Configuración Manual.',
    ...
    },
    {
      ...
      description: 'Comenzamos creando programas académicos. HAZ CLIC en "Programas" en el menú lateral (el tour avanzará automáticamente cuando hagas clic).',
    ...
    },
    {
      ...
      description: 'Excelente! Estás en el formulario. Completa los datos: Nombre: "Ingeniería de Sistemas", Semestres: 10, Estado: Activo y HAZ CLIC en "Crear Programa".',
      position: 'bottom'
    },
    {
      id: 'step-1-periods',
    ...
    },
    {
      ...
      description: 'Crea las asignaturas: MAT101-Cálculo Diferencial (4 créditos), PRG101-Programación I (4 créditos), FIS101-Física I (4 créditos), ALG101-Álgebra Lineal (3 créditos).',
    ...
    },
    {
      ...
      title: 'Crear Grupos',
      description: 'Crea grupos para cada asignatura (ej: Cálculo Diferencial - Grupo A, con Dr. Carlos Mendoza, Aula 201, horario Lunes y Miércoles 8:00-10:00, capacidad 30).',
    ...
    },
    {
      ...
      description: 'Registra a Ana García Rodríguez (código 2024001, CC 1234567890, ana.garcia@modulyx.edu.co) en Ingeniería de Sistemas, Semestre 1.',
    ...
    },
    {
      ...
      description: 'Matricula a Ana García en todas las asignaturas del primer semestre: Cálculo Diferencial, Programación I, Física I y Álgebra Lineal.',
    ...
    },
    {
      ...
      description: 'Has completado exitosamente la configuración manual del Sistema SIA. Puedes ver las métricas actualizadas y gestionar el sistema desde aquí.',
