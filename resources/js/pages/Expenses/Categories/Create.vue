...
<template>
    <Head title="Nueva Categoría de Gastos" />

    <AppLayout title="Nueva Categoría de Gastos" :breadcrumbs="breadcrumbs">
        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription> Complete los detalles de la nueva categoría de gastos </CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            <Button type="button" variant="outline" @click="$inertia.visit(route('expense-categories.index'))"> Cancelar </Button>
