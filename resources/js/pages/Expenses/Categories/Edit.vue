        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription> Modifique los detalles de la categoría de gastos </CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end space-x-4">
                            <Button type="button" variant="outline" @click="$inertia.visit(route('expense-categories.show', category.id))">
                                Cancelar
                            </Button>
