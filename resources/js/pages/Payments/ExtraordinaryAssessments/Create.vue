...
import { ArrowLeft, Info, Calculator } from 'lucide-vue-next'
...
const submit = () => {
  form.post(route('extraordinary-assessments.store'))
}
</script>

<template>
  <AppLayout>
    <Head title="Nueva Cuota Extraordinaria" />
    ...
    <div class="py-8">
      <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
          ...
          <h1 class="text-3xl font-bold text-gray-900">Nueva Cuota Extraordinaria</h1>
          <p class="mt-2 text-sm text-gray-600">
            Crea un nuevo proyecto de cuota extraordinaria para recaudar fondos especiales
          </p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <Card>
            ...
            <CardContent class="space-y-4">
              ...
              <div>
                ...
                <Select v-model="form.distribution_type">
            ...
            <CardContent>
              ...
              <Alert class="mt-4 bg-white border-blue-300">
                ...
                <AlertDescription class="text-sm text-blue-700">
                  <span v-if="form.distribution_type === 'by_coefficient'">
                    Los montos exactos se calcularán según el coeficiente de copropiedad de cada apartamento al activar la cuota extraordinaria.
                  </span>
                  <span v-else>
          ...
          <Alert>
            <Info class="h-4 w-4" />
            <AlertDescription>
              La cuota extraordinaria se creará en estado <strong>Borrador</strong>.
              Deberás activarla para que comience a generar cobros automáticos en las facturas mensuales.
            </AlertDescription>
          </Alert>
          ...
          <div class="flex items-center justify-end space-x-4">
            ...
            <Button type="submit" :disabled="form.processing">
              {{ form.processing ? 'Creando...' : 'Crear Cuota Extraordinaria' }}
            </Button>
          </div>
        </form>
      </div>
