...
const columns = [
    ...
    columnHelper.accessor('due_date', {
        ...
        cell: ({ row }) => {
            ...
            return h('div', { 
                class: cn('text-sm', isOverdue ? 'text-red-600 font-medium' : 'text-muted-foreground')
                ...
                <div class="flex items-center justify-between pb-4">
                    <div class="flex items-center space-x-2">
                        <p class="text-sm text-muted-foreground">
                            Mostrando {{ props.invoices.from || 0 }} a {{ props.invoices.to || 0 }} 
                            de {{ props.invoices.total }} facturas
                        </p>
                    </div>
        ...
        <div class="flex gap-2 items-center py-4">
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                    ...
                    >
                        {{ column.id === 'invoice_number' ? 'Número' : 
                             column.id === 'apartment' ? 'Apartamento' :
                             column.id === 'type' ? 'Tipo' :
                             column.id === 'billing_period_label' ? 'Período' :
                             column.id === 'total_amount' ? 'Total' :
                             column.id === 'balance_due' ? 'Saldo' :
