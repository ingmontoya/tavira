<template>
  <div class="fixed inset-0 z-50 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
      ...
      <!-- Modal -->
      <div
        class="inline-block w-full max-w-2xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl relative z-50">
        <!-- Header -->
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <input v-model="form.conjunto_name" type="text" required
            ...
            <div>
              ...
              <input v-model="form.conjunto_address" type="text"
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
