...
const form = useForm<FormData>({
    document_type: props.resident.document_type,
    document_number: props.resident.document_number,
    ...
    mobile_phone: props.resident.mobile_phone,
    birth_date: props.resident.birth_date,
    gender: props.resident.gender,
    emergency_contact: props.resident.emergency_contact,
    apartment_id: props.resident.apartment_id,
    resident_type: props.resident.resident_type,
    status: props.resident.status,
    start_date: props.resident.start_date,
    end_date: props.resident.end_date,
    notes: props.resident.notes,
    documents: [],
    email_notifications: props.resident.email_notifications ?? true,
    whatsapp_notifications: props.resident.whatsapp_notifications ?? false,
...
const findApartmentByNumber = () => {
    ...
    let apartment = props.apartments.find((apt) => apt.number === searchNumber || getDisplayNumber(apt) === searchNumber);
    ...
    if (!apartment && searchNumber.length === 4) {
        ...
        apartment = props.apartments.find((apt) => {
            return apt.tower === tower && apt.floor === floor && apt.number === searchNumber;
        });
    }
...
const breadcrumbs = [
    ...
    { title: 'Editar Residente', href: `/residents/${props.resident.id}/edit` },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto max-w-6xl px-4 py-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div class="space-y-1">
                    <h1 class="text-3xl font-bold tracking-tight">Editar Residente</h1>
                    <p class="text-muted-foreground">Actualiza la información del residente</p>
                </div>
                    ...
                    <AlertDialog v-if="isUnsavedChanges">
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                ...
                                <AlertDialogDescription> Tienes cambios sin guardar. ¿Estás seguro de que deseas salir?
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                ...
                <CardHeader>
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription> Completa todos los campos requeridos para actualizar el residente
                            </CardDescription>
                        </div>
            ...
            <div class="mb-8 grid grid-cols-4 gap-4">
                <div v-for="(step, index) in steps" :key="step.id" @click="goToStep(index)" :class="[
                        ...
                        <CardContent class="space-y-4">
                            <div class="space-y-2">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium">{{ form.first_name || 'Nombre' }} {{
                                            form.last_name || 'Apellido' }}</p>
                                        <p class="text-xs text-muted-foreground">{{ form.document_type }} {{
                                            form.document_number || 'N/A' }}</p>
                                    </div>
                                </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <CardContent class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div class="space-y-2">
                                        ...
                                        <Select v-model="form.document_type">
                                            ...
                                            <SelectContent>
                                                <SelectItem v-for="type in documentTypes" :key="type.value"
                                                    :value="type.value">
                                                    {{ type.label }}
                                                </SelectItem>
                                            </SelectContent>
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div class="space-y-2">
                                        ...
                                        <Input id="first_name" v-model="form.first_name" placeholder="Nombres completos"
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input id="last_name" v-model="form.last_name" placeholder="Apellidos completos"
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div class="space-y-2">
                                        ...
                                        <Input id="phone" v-model="form.phone" placeholder="(601) 123-4567"
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input id="mobile_phone" v-model="form.mobile_phone"
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Select v-model="form.gender">
                                            ...
                                            <SelectContent>
                                                <SelectItem v-for="gender in genderOptions" :key="gender.value"
                                                    :value="gender.value">
                                                    {{ gender.label }}
                                                </SelectItem>
                                            </SelectContent>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Textarea id="emergency_contact" v-model="form.emergency_contact"
                                        placeholder="Nombre, teléfono y relación del contacto de emergencia"
                                        :class="{ 'border-red-500': form.errors.emergency_contact }" rows="3" />
                            ...
                            <CardContent class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input id="direct_apartment" v-model="directApartmentNumber"
                                            placeholder="Ej: 1101, 2305, etc." @input="findApartmentByNumber"
                                            class="font-mono" />
                                        <p class="text-xs text-muted-foreground">
                                            Ingresa el número completo del apartamento (1101 = Torre 1, Piso 1, Apto
                                            101)
                                        </p>
                                    </div>
                                    ...
                                    <div class="space-y-4">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm text-muted-foreground">O selecciona por torre y
                                                piso</span>
                                            <div class="h-px flex-1 bg-border"></div>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-3 gap-4">
                                            <div class="space-y-2">
                                                ...
                                                <Select v-model="selectedTower" @update:model-value="filterApartments">
                                                    ...
                                                    <SelectContent>
                                                        <SelectItem v-for="tower in availableTowers" :key="tower"
                                                            :value="tower">
                                                            Torre {{ tower }}
                                                        </SelectItem>
                                                    </SelectContent>
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <Select v-model="selectedFloor" @update:model-value="filterApartments"
                                                    :disabled="!selectedTower">
                                                    <SelectTrigger>
                                                        <SelectValue placeholder="Piso" />
                                                    </SelectTrigger>
                                                    <SelectContent>
                                                        <SelectItem v-for="floor in availableFloors" :key="floor"
                                                            :value="floor">
                                                            Piso {{ floor }}
                                                        </SelectItem>
                                                    </SelectContent>
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <Select v-model="form.apartment_id" :disabled="!selectedFloor">
                                                    ...
                                                    <SelectContent>
                                                        <SelectItem v-for="apartment in filteredApartments"
                                                            :key="apartment.id" :value="apartment.id">
                                    ...
                                    <div v-if="selectedApartment" class="rounded-lg bg-muted p-4">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <Badge
                                                :variant="selectedApartment.status === 'Available' ? 'secondary' : 'default'">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Select v-model="form.resident_type">
                                        ...
                                        <SelectContent>
                                            <SelectItem v-for="type in residentTypes" :key="type.value"
                                                :value="type.value">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Select v-model="form.status">
                                        ...
                                        <SelectContent>
                                            <SelectItem v-for="status in statusOptions" :key="status.value"
                                                :value="status.value">
                                                <div class="flex items-center gap-2">
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <p class="text-xs text-muted-foreground">Deja en blanco si no hay fecha de fin
                                        </p>
                        ...
                        <Card v-if="currentStep === 2">
                            <CardHeader>
                                ...
                                <CardDescription> Sube documentos relevantes y agrega notas adicionales
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                <!-- File upload -->
                                <div class="space-y-2">
                                    ...
                                    <div
                                        class="rounded-lg border-2 border-dashed p-8 text-center transition-colors hover:border-primary/50">
                                        <Upload class="mx-auto mb-4 h-12 w-12 text-muted-foreground" />
                                        <div class="space-y-2">
                                            <Label for="documents" class="cursor-pointer">
                                                <span class="font-medium text-primary hover:text-primary/80"> Haz clic
                                                    para subir archivos </span>
                                                <input id="documents" type="file" multiple
                                                    accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" class="sr-only"
                                                    @change="handleFileUpload" />
                                            </Label>
                                            <p class="text-sm text-muted-foreground">PDF, DOC, DOCX, JPG, PNG hasta 10MB
                                                cada uno</p>
                                        </div>
                                    </div>
                                    ...
                                    <div v-if="resident.documents && resident.documents.length > 0" class="space-y-2">
                                        ...
                                        <div class="space-y-2">
                                            <div v-for="document in resident.documents" :key="document.id"
                                            ...
                                            <div v-for="(file, index) in form.documents" :key="index"
                                                ...
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-xs text-muted-foreground">{{ (file.size / 1024 /
                                                            1024).toFixed(2) }} MB</p>
                                                    </div>
                                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Textarea id="notes" v-model="form.notes"
                                        ...
                                        :class="{ 'border-red-500': form.errors.notes }" rows="4" />
                        ...
                        <Card v-if="currentStep === 3">
                            <CardHeader>
                                ...
                                <CardDescription> Configura las preferencias de notificaciones del residente
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                <!-- Email notifications -->
                                <div class="flex items-center justify-between rounded-lg border p-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-muted-foreground">Recibir notificaciones importantes
                                    ...
                                    <div class="flex items-center justify-between rounded-lg border p-4">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm text-muted-foreground">Recibir notificaciones y
                                                    recordatorios por WhatsApp</p>
                                            </div>
                                        </div>
                                        <Switch v-model:checked="form.whatsapp_notifications"
                        ...
                        <div class="flex items-center justify-between pt-6">
                            <Button type="button" variant="outline" :disabled="isFirstStep" @click="prevStep"
                                class="gap-2">
                                <ArrowLeft class="h-4 w-4" />
                                Anterior
                            </Button>
                            ...
                            <div class="flex items-center gap-3">
                                <Button v-if="!isLastStep" type="button" :disabled="!canProceedToNext" @click="nextStep"
                                    class="gap-2">
                                    Siguiente
                                    <ArrowLeft class="h-4 w-4 rotate-180" />
                                </Button>

                                <Button v-if="isLastStep" type="submit" :disabled="form.processing || !canProceedToNext"
                                    class="gap-2">
                                    <Save class="h-4 w-4" />
                                    {{ form.processing ? 'Guardando...' : 'Actualizar Residente' }}
                                </Button>
                            </div>
                        </div>
                    </form>
