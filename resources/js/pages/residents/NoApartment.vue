            ...
            <div class="flex min-h-[60vh] items-center justify-center">
                <Card class="w-full max-w-md">
                    <CardHeader class="text-center">
                        ...
                        <CardTitle class="text-xl font-semibold text-gray-900"> Apartamento no asignado </CardTitle>
                    ...
                    <CardFooter class="flex justify-center">
                        <Button @click="contactAdmin" variant="default"> Contactar Administrador </Button>
                    </CardFooter>
                </Card>
            </div>
        </div>
...
const contactAdmin = () => {
    ...
    window.location.href = 'mailto:admin@habitta.com?subject=Solicitud de asignación de apartamento';
};
</script>
