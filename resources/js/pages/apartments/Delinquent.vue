    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div class="space-y-6">
                                    ...
                                    <div class="flex items-start justify-between">
                                        <div class="space-y-2 flex-1">
                                            ...
                                            <div class="text-sm text-muted-foreground space-y-1">
                                                <div>{{ apartment.apartment_type?.name || 'N/A' }} - {{ formatCurrency(apartment.monthly_fee) }}/mes</div>
                                                <div v-if="apartment.outstanding_balance > 0">
                                                    Saldo pendiente: {{ formatCurrency(apartment.outstanding_balance) }}
                                                </div>
                                                <div>
                                                    Último pago: {{ formatDate(apartment.last_payment_date) }}
                                                </div>
                                            </div>
                ...
                <div v-if="Object.keys(delinquentApartments).length === 0" class="text-center py-12">
