...
const breadcrumbs = [
    ...
    { title: 'Nueva Asamblea', href: '/assemblies/create' },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto max-w-6xl px-4 py-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div class="space-y-1">
                    <h1 class="text-3xl font-bold tracking-tight">Nueva Asamblea</h1>
                    <p class="text-muted-foreground">Programa una nueva asamblea para tu conjunto residencial</p>
                </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <Card v-if="currentStep === 0">
                            <CardHeader>
                                ...
                                <CardDescription>Ingresa los datos básicos de la asamblea</CardDescription>
                            </CardHeader>
