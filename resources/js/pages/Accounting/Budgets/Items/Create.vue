...
// Reset monthly distribution when toggling
...
const breadcrumbs = [
    ...
    { title: 'Agregar Partida', href: '#' },
];
</script>

<template>
    <Head title="Agregar Partida Presupuestal" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto max-w-4xl px-4 py-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <div class="space-y-1">
                    <h1 class="text-3xl font-bold tracking-tight">Agregar Partida Presupuestal</h1>
                        ...
                        <Card>
                            ...
                            <CardContent class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p v-if="availableAccounts.length === 0" class="text-xs text-muted-foreground">
                                        No hay más cuentas {{ form.category === 'income' ? 'de ingresos' : 'de gastos' }} disponibles
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
