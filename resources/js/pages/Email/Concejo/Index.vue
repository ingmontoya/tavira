...
import { Archive, Mail, MailOpen, Plus, RefreshCw, Search, StarOff, Trash2, Users } from 'lucide-vue-next';
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Button @click="$inertia.visit(route('email.concejo.compose'))" size="sm">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-4">
                ...
                <Card class="lg:col-span-1">
                    ...
                    <CardContent class="space-y-2">
                        ...
                        <!-- Quick Access -->
                        <div class="space-y-1">
                            <h4 class="text-xs font-medium tracking-wider text-muted-foreground uppercase">Acceso Rápido</h4>
                            <div class="flex cursor-pointer items-center gap-2 rounded-lg p-2 hover:bg-muted">
                                <Users class="h-4 w-4" />
