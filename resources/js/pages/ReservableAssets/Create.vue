    ...
    <AppLayout>
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Configura un nuevo activo que los residentes
                    puedan reservar</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <Textarea v-model="form.description"
                                placeholder="Describe las características y amenidades del activo..." rows="3" />
                            ...
                            <div class="mt-2">
                                ...
                                <div v-else
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="mb-2 text-sm text-gray-600 dark:text-gray-400">Haz clic para subir una
                                            imagen</p>
                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                <Select v-model="form.reservation_duration_minutes">
                                    ...
                                    <SelectContent>
                                        <SelectItem v-for="option in formatDurationOptions" :key="option.value"
                            ...
                            <div class="space-y-2">
                                ...
                                <Input v-model="form.reservation_cost" type="number" min="0" step="1000"
                                    placeholder="0" />
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription> Define cuándo está disponible el activo para reservas (opcional)
                        </CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-6">
                        <!-- Days of Week -->
                        <div class="space-y-3">
                            ...
                            <div class="grid grid-cols-2 gap-3 md:grid-cols-4">
                                <div v-for="day in daysOfWeek" :key="day.value" class="flex items-center space-x-2">
                                    <Checkbox :checked="form.availability_rules.allowed_days.includes(day.value)"
                        ...
                        <div class="space-y-3">
                            ...
                            <div v-for="(slot, index) in form.availability_rules.time_slots" :key="index"
