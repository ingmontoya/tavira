...
import { AlertCircle, ArrowLeft, FileText, MessageSquare, Paperclip, Upload, X } from 'lucide-vue-next';
import { ref } from 'vue';
...
const breadcrumbs = [
    ...
    { label: 'Crear', href: '#', current: true }
];
</script>

<template>
    <Head title="Crear PQRS" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto max-w-4xl space-y-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">Crear PQRS</h1>
                    <p class="text-gray-600">Complete el formulario para enviar su Petición, Queja, Reclamo o Sugerencia</p>
                </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Agrega documentos, fotos o evidencias relacionadas con tu solicitud</CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-4">
                        ...
                        <div v-if="selectedFiles.length > 0" class="space-y-2">
                            <h4 class="font-medium text-gray-900">Archivos seleccionados:</h4>
                            <div class="space-y-2">
                                <div
                ...
                <div class="flex items-center justify-end gap-4">
                    <Button :as="Link" :href="route('pqrs.index')" variant="outline">
                        Cancelar
                    </Button>
                    <Button
                        type="submit"
