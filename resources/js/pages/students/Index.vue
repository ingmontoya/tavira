...
const filteredData = computed(() => {
    ...
    if (customFilters.value.program !== 'all') {
        filtered = filtered.filter(student => 
            student.program?.id.toString() === customFilters.value.program
        )
    }
    ...
    if (customFilters.value.gender !== 'all') {
        filtered = filtered.filter(student => 
            student.gender === customFilters.value.gender
        )
    }
    ...
    if (customFilters.value.progressRange !== 'all') {
        filtered = filtered.filter(student => {
            ...
            switch (customFilters.value.progressRange) {
                ...
                case 'medium-low': return progress >= 25 && progress < 50
                case 'medium-high': return progress >= 50 && progress < 75
    ...
    if (customFilters.value.group !== 'all') {
        filtered = filtered.filter(student => 
            student.group === customFilters.value.group
        )
    }
