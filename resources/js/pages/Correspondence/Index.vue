...
import { Edit, Eye, FileText, Filter, Mail, MoreHorizontal, Package, Plus, Search, Trash2 } from 'lucide-vue-next';
import { ref } from 'vue';
        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Gestión de correspondencia y paquetes del conjunto</p>
                </div>
            ...
            <Card class="p-6">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                    <div>
                        <Input v-model="search" placeholder="Buscar por número, remitente..." @keyup.enter="applyFilters">
                            <template #prefix>
                    ...
                    <Select v-if="apartments.length > 0" v-model="apartmentFilter" @update:model-value="applyFilters">
                        <SelectTrigger>
                    ...
                    <Table>
                        <TableHeader class="bg-gray-50">
                            <TableRow class="border-b-2 border-gray-200">
                                <TableHead class="py-4 font-semibold text-gray-900">Número de Seguimiento</TableHead>
                                <TableHead class="py-4 font-semibold text-gray-900">Tipo</TableHead>
                                <TableHead class="py-4 font-semibold text-gray-900">Remitente</TableHead>
                                <TableHead class="py-4 font-semibold text-gray-900">Apartamento</TableHead>
                                <TableHead class="py-4 font-semibold text-gray-900">Estado</TableHead>
                                <TableHead class="py-4 font-semibold text-gray-900">Fecha Recepción</TableHead>
                                <TableHead class="py-4 font-semibold text-gray-900">Evidencia</TableHead>
                                <TableHead class="py-4 text-right font-semibold text-gray-900">Acciones</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
                            <TableRow
                            ...
                            >
                                ...
                                <TableCell>
                                    <div class="flex items-center space-x-2">
                                        <component :is="getTypeIcon(correspondence.type)" class="h-4 w-4 text-gray-500" />
                                ...
                                <TableCell>
                                    <div>
                                        ...
                                        <div v-if="correspondence.sender_company" class="text-sm text-gray-500">
                                ...
                                <TableCell>
                                    <div class="font-medium">{{ correspondence.apartment.tower }}-{{ correspondence.apartment.number }}</div>
                                    <div class="text-sm text-gray-500">Piso {{ correspondence.apartment.floor }}</div>
                                </TableCell>
                                ...
                                <TableCell>
                                    <div class="text-sm">{{ correspondence.attachments.length }} archivo(s)</div>
                                </TableCell>
                ...
                <div class="border-t border-gray-200 px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            Mostrando {{ correspondences.from }} a {{ correspondences.to }} de {{ correspondences.total }} resultados
                        </div>
