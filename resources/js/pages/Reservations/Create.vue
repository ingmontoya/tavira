    ...
    <AppLayout>
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            <div class="mb-6">
                ...
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Selecciona un activo y horario para crear tu
                    reserva</p>
            </div>
                            ...
                            <form @submit.prevent="submit">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Select v-model="form.reservable_asset_id" required>
                                        ...
                                        <SelectContent>
                                            <SelectItem v-for="asset in assets" :key="asset.id"
                                                :value="asset.id.toString()" :disabled="!asset.can_user_reserve">
                                ...
                                <div v-if="selectedAsset" class="space-y-2">
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Puedes reservar hasta {{ selectedAsset.advance_booking_days }} días de
                                        anticipación
                                    </p>
                                </div>
                                ...
                                <div v-if="selectedDate && selectedAsset" class="space-y-2">
                                    ...
                                    <div v-else class="grid grid-cols-2 gap-2 sm:grid-cols-3">
                                        <button v-for="slot in availableSlots" :key="slot.start_time" type="button"
                                            @click="selectSlot(slot)" :disabled="!slot.available" :class="[
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Textarea v-model="form.notes"
                                        placeholder="Información adicional sobre tu reserva..." rows="3" />
                                ...
                                <div class="flex justify-end space-x-3 pt-6">
                                    ...
                                    <Button type="submit" :disabled="form.processing || !selectedSlot"
                ...
                <div v-if="selectedAsset" class="space-y-6">
                    <Card>
                        ...
                        <CardContent class="space-y-4">
                            <div v-if="selectedAsset.image_url"
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center text-sm">
                                    ...
                                    <span>Duración: {{ formatDuration(selectedAsset.reservation_duration_minutes)
                                        }}</span>
                                </div>
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span>
                                        ...
                                        <span class="font-medium">
                                            {{ selectedAsset.reservation_cost > 0 ?
                                                formatCurrency(selectedAsset.reservation_cost) : 'Gratis' }}
                                        </span>
                                    </span>
                                </div>
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span>Máximo {{ selectedAsset.max_reservations_per_user }} reserva(s)
                                        activa(s)</span>
                                </div>
                            </div>
                            ...
                            <div v-if="selectedAsset.requires_approval" class="mt-4">
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        Este activo requiere aprobación administrativa. Tu reserva quedará pendiente
                                        hasta ser aprobada.
                                    </AlertDescription>
                                </Alert>
                            </div>
                    ...
                    <Card v-if="selectedSlot">
                        ...
                        <CardContent class="space-y-3">
                            ...
                            <div class="text-sm">
                                ...
                                <span class="ml-2 font-medium">{{ selectedSlot.start_time }} - {{ selectedSlot.end_time
                                    }}</span>
                            </div>
                            <div class="text-sm">
                                <span class="text-gray-600 dark:text-gray-400">Duración:</span>
                                <span class="ml-2 font-medium">{{
                                    formatDuration(selectedAsset.reservation_duration_minutes) }}</span>
                            </div>
                            <div class="text-sm">
