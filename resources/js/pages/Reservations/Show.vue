        ...
        <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Reserva #{{ reservation.id }}
                        </h1>
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div v-if="isAdmin && reservation.status === 'pending'" class="flex space-x-2">
                            ...
                            <Button size="sm" variant="outline" @click="rejectReservation"
                        ...
                        <div v-if="!isAdmin && reservation.can_be_cancelled" class="flex space-x-2">
                            <Button size="sm" variant="outline" :href="route('reservations.edit', reservation.id)"
                                as="link">
                                <Edit class="mr-1 h-4 w-4" />
                                Editar
                            </Button>
                            <Button size="sm" variant="outline" @click="cancelReservation"
                                class="text-red-600 hover:bg-red-50">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            ...
                            <div v-if="reservation.approved_at" class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">
                                        ...
                                        <span v-if="reservation.approved_by"> por {{ reservation.approved_by.name }}
                                        </span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div v-if="reservation.cancelled_at" class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">
                                        ...
                                        <span v-if="reservation.cancelled_by"> por {{ reservation.cancelled_by.name }}
                                        </span>
                                    </p>
                                </div>
                            </div>
                ...
                <div class="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div v-if="reservation.reservable_asset.image_url" class="mb-4">
                                <img :src="reservation.reservable_asset.image_url"
                                    :alt="reservation.reservable_asset.name"
                                    class="h-32 w-full rounded-lg object-cover" />
                            </div>

                            <div v-if="reservation.reservable_asset.description"
                    ...
                    <!-- Status Alert -->
                    <Alert v-if="reservation.status === 'pending'"
                    ...
                    <Alert v-else-if="reservation.status === 'approved'"
                    ...
                    <Alert v-else-if="reservation.status === 'rejected'"
