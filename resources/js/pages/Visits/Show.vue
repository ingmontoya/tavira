...
import { ArrowLeft, Download, Share, User, Shield, QrCode } from 'lucide-vue-next';
        ...
        <div class="container mx-auto px-6 py-8 max-w-4xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    ...
                    <div id="visit-ticket" class="relative overflow-hidden bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg shadow-xl max-w-sm mx-auto">
                        ...
                        <div class="p-4">
                            ...
                            <div class="text-center mb-3">
                                <div class="inline-flex items-center gap-1 bg-white/10 backdrop-blur-sm rounded px-2 py-1 mb-2">
                            ...
                            <div class="text-center mb-3 space-y-1">
                                ...
                                <div class="text-sm text-blue-200">
                                    Torre {{ visit.apartment.tower }} - Apt {{ visit.apartment.number }}
                                </div>
                            </div>

                            <!-- QR Code Section -->
                            <div class="text-center mb-3">
                                <div class="inline-block p-2 bg-white rounded-lg shadow-inner">
                                    <div ref="qrCodeRef" class="flex justify-center"></div>
                                </div>
                                <div class="mt-2 font-mono text-xs text-blue-100 tracking-wider">
                                    {{ visit.qr_code }}
                                </div>
                            </div>

                            <!-- Compact Validity -->
                            <div class="border-t border-blue-400/30 pt-2 space-y-1">
                            ...
                            <div class="flex justify-center mt-3">
                                <div class="inline-flex items-center gap-1 bg-white/20 backdrop-blur-sm rounded-full px-3 py-1">
                                    <div :class="[
                                        'w-2 h-2 rounded-full',
                                        visit.status === 'pending' ? 'bg-yellow-400' :
                                        visit.status === 'active' ? 'bg-blue-400' :
                                        visit.status === 'used' ? 'bg-green-400' :
                                        'bg-red-400'
                                    ]"></div>
                            ...
                            <div class="grid grid-cols-1 gap-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-base font-mono">{{ visit.visitor_document_number }}</div>
                                    </div>
                                </div>
