                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-amber-600">
                                Esta votación está en estado "{{ getStatusBadge(vote.status).text }}" y no puede ser editada. Solo las votaciones en
                                estado "Borrador" pueden modificarse.
                            </p>
                        </div>
                    </div>
                </CardContent>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription> Edita los detalles principales de la votación </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription> Modifica el tipo de votación y los requisitos de aprobación </CardDescription>
                    </CardHeader>
                    <CardContent class="space-y-6">
                        <!-- Vote Type -->
                        <div class="space-y-3">
                            <Label for="type">Tipo de Votación *</Label>
                            <Select v-model="form.type" @update:model-value="updatePercentage" :disabled="!canEdit">
                                <SelectTrigger>
                ...
                <Card v-if="form.title">
                    <CardHeader>
                        ...
                        <CardDescription> Vista previa de cómo aparecerá la votación actualizada </CardDescription>
                    </CardHeader>
