        ...
        <SettingsLayout>
            <div class="space-y-6">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">Configurar descuentos por pronto pago y cálculo de intereses de mora.</p>
                </div>
                ...
                <form @submit.prevent="updateSettings" class="space-y-8">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription> Configurar descuentos para pagos realizados dentro del período establecido. </CardDescription>
                        </CardHeader>
                        <CardContent class="space-y-4">
                            <div class="flex items-center space-x-2">
                                <Switch id="early-discount" v-model:checked="form.early_discount_enabled" />
                            ...
                            <div v-if="form.early_discount_enabled" class="space-y-4">
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div class="space-y-2">
                                        ...
                                        <Input id="discount-days" type="number" v-model.number="form.early_discount_days" min="1" max="30" required />
                                        <p class="text-xs text-gray-500">Número de días desde la fecha de facturación para aplicar el descuento</p>
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            required
                                        />
                                        <p class="text-xs text-gray-500">Porcentaje de descuento sobre el subtotal de la factura</p>
                                    </div>
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription> Configurar el cálculo de intereses para facturas vencidas. </CardDescription>
                        </CardHeader>
                        <CardContent class="space-y-4">
                            <div class="flex items-center space-x-2">
                                <Switch id="late-fees" v-model:checked="form.late_fees_enabled" />
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div class="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            required
                                        />
                                        <p class="text-xs text-gray-500">Porcentaje mensual aplicado sobre el subtotal de la factura</p>
                                    </div>

                                    <div class="space-y-2">
                                        <Label for="grace-period">Días de gracia</Label>
                                        <Input id="grace-period" type="number" v-model.number="form.grace_period_days" min="0" max="30" required />
                                        <p class="text-xs text-gray-500">Días después del vencimiento antes de aplicar intereses</p>
                                    </div>
                                </div>

                                <div class="flex items-center space-x-2">
                                    <Switch id="compound-monthly" v-model:checked="form.late_fees_compound_monthly" />
                                    <Label for="compound-monthly">Aplicar interés compuesto mensual</Label>
                                </div>
                                <p class="text-xs text-gray-500">
                                    Si está habilitado, los intereses se calculan de forma compuesta cada mes. Si está deshabilitado, se aplica
                                    interés simple.
                                </p>
                            </div>
                        </CardContent>
...
import { AlertTriangleIcon, PercentIcon } from 'lucide-vue-next';
