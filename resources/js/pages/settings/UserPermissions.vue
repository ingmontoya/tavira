...
const getRoleBadgeVariant = (roleName: string) => {
    switch (roleName) {
        ...
        case 'admin_conjunto': return 'default';
        case 'consejo': return 'secondary';
        case 'propietario': return 'outline';
        case 'residente': return 'outline';
        case 'porteria': return 'secondary';
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">
                        Configura los roles y permisos de cada usuario en el sistema.
                    </p>
                </div>
                            ...
                            <div v-if="selectedUser" class="space-y-4">
                                ...
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            Permisos específicos para {{ selectedUser.name }}
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent class="space-y-4">
                                        <div
                                                ...
                                                >
                                                    <input
                                                        ...
                                                        @change="(event) => {
                                                            ...
                                                            if (checked) {
                                                                userPermissionsForm.permissions = [...(userPermissionsForm.permissions || []), permission.name];
                                                            } else {
                                                                userPermissionsForm.permissions = (userPermissionsForm.permissions || []).filter(p => p !== permission.name);
                                                            }
                                                        }"
                                        ...
                                        <Button
                                            ...
                                            :disabled="userPermissionsForm.processing"
                                            class="w-full"
                                        >
                                                ...
                                                >
                                                    <input
                                                        ...
                                                        @change="(event) => {
                                                            const checked = (event.target as HTMLInputElement).checked;
                                                            if (checked) {
                                                                rolePermissionsForm.permissions = [...(rolePermissionsForm.permissions || []), permission.name];
                                                            } else {
                                                                rolePermissionsForm.permissions = (rolePermissionsForm.permissions || []).filter(p => p !== permission.name);
                                                            }
                                                        }"
                                                        class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"
                                                    />
                                                    <Label
                                                        :for="`role-perm-${permission.id}`"
                                                        class="text-sm font-normal"
                                                    >
                                                        {{ getPermissionDisplayName(permission.name) }}
                                                    </Label>
