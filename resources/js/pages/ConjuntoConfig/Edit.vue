                ...
                <CardHeader>
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Modifica la configuración del conjunto paso a paso
                            </CardDescription>
                        </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <Card v-if="currentStep === 0">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Modifica los datos generales del conjunto residencial
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-muted-foreground">
                                        Los conjuntos inactivos no aparecerán en los listados principales
                                    </p>
                                </div>
                        ...
                        <Card v-if="currentStep === 1">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Modifica los nombres de las torres
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div
                                            v-for="(_, index) in form.tower_names"
                                            :key="index"
                                            class="space-y-2"
                                        >
                        ...
                        <Card v-if="currentStep === 2">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Modifica los diferentes tipos de apartamento y sus características
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                <div class="flex items-center justify-between">
