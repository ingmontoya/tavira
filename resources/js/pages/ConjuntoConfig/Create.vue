...
watch(() => form.number_of_towers, (newCount, oldCount) => {
            ...
            <div class="flex items-center justify-between mb-8">
                <div class="space-y-1">
                    ...
                    <p class="text-muted-foreground">
                        Configura un nuevo conjunto y genera apartamentos automáticamente
                    </p>
                </div>
                ...
                <CardHeader>
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Define la estructura del conjunto paso a paso
                            </CardDescription>
                        </div>
                ...
                <div
                    ...
                    :class="[
                        'relative p-4 rounded-lg border cursor-pointer transition-all duration-200',
                        {
                            ...
                            'bg-green-50 border-green-200 text-green-800': index < currentStep,
                        ...
                        <CardContent class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <p class="text-sm font-medium">
                                            {{ form.apartment_types.length }} tipos
                                        </p>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex flex-wrap gap-1">
                                    <Badge
                                        v-for="tower in form.tower_names"
                                        :key="tower"
                                        variant="outline"
                                        class="text-xs"
                                    >
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="space-y-1">
                                    <div
                                        v-for="type in form.apartment_types"
                                        :key="type.name"
                                        class="text-xs text-muted-foreground"
                                    >
                                        {{ type.name }} ({{ type.area_sqm }}m²)
                                    </div>
                                    <p v-if="form.apartment_types.length === 0" class="text-xs text-muted-foreground">
                                        Sin tipos definidos
                                    </p>
                                </div>
                            </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <Card v-if="currentStep === 0">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Define los datos generales del conjunto residencial
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                ...
                                <div class="p-4 bg-muted/50 rounded-lg">
                                    ...
                                    <p class="text-sm text-muted-foreground">
                                        Se generarán <strong>{{ totalApartments }} apartamentos</strong> en total
                                        ({{ form.number_of_towers }} torres × {{ form.floors_per_tower }} pisos × {{ form.apartments_per_floor }} apartamentos)
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card v-if="currentStep === 1">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Define los nombres de las torres del conjunto
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div
                                            v-for="(tower, index) in form.tower_names"
                                            :key="index"
                                            class="space-y-2"
                                        >
                        ...
                        <Card v-if="currentStep === 2">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Define los diferentes tipos de apartamento y sus características
                                </CardDescription>
                            </CardHeader>
                            <CardContent class="space-y-6">
                                <div class="flex items-center justify-between">
                                    <p class="text-sm text-muted-foreground">
                                        Define al menos un tipo de apartamento para continuar
                                    </p>
                                ...
                                <div v-if="form.apartment_types.length === 0" class="text-center py-8">
                                    <Home class="mx-auto h-12 w-12 text-muted-foreground mb-4" />
                                    <h3 class="text-lg font-medium mb-2">Sin tipos de apartamento</h3>
                                    <p class="text-muted-foreground mb-4">
                                        Agrega al menos un tipo de apartamento para continuar
                                    </p>
                                ...
                                <div v-else class="space-y-6">
                                    <div
                                        v-for="(type, index) in form.apartment_types"
                                        :key="index"
                                    ...
                                    >
                                        <div class="flex items-center justify-between">
                                            ...
                                            <Button
                                                ...
                                                variant="destructive"
                                                size="sm"
                                                @click="removeApartmentType(index)"
                                            >
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <Textarea
                                                ...
                                                placeholder="Descripción del tipo de apartamento..."
                                                rows="2"
                                            />
                                        </div>
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                <Input
                                                    v-model.number="type.administration_fee"
                                                    type="number"
                                                    min="0"
                                                />
                                            </div>
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                <div class="flex items-center space-x-2">
                                                    <Switch
                                                        :id="`balcony_${index}`"
                                                        v-model:checked="type.has_balcony"
                                                    />
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    <Switch
                                                        :id="`laundry_${index}`"
                                                        v-model:checked="type.has_laundry_room"
                                                    />
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    <Switch
                                                        :id="`maid_${index}`"
                                                        v-model:checked="type.has_maid_room"
                                                    />
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <Label :for="`position_${index}_${position}`">
                                                        Posición {{ position }}
                                                    </Label>
                                                </div>
                                            </div>
