...
import { FileSpreadsheet, Download, Upload, AlertCircle, CheckCircle2 } from 'lucide-vue-next'
  ...
  <Dialog v-model:open="isOpen">
    ...
    <DialogContent class="sm:max-w-[500px]">
      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <Button 
            ...
            class="text-blue-600 border-blue-300 hover:bg-blue-100"
          >
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            ...
            />
            <Upload class="absolute right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400 pointer-events-none" />
          </div>
          ...
          <Alert v-if="selectedFile && !isValidFileType" variant="destructive">
            ...
            <AlertDescription>
              Tipo de archivo no válido. Solo se permiten archivos .xlsx, .xls y .csv
            </AlertDescription>
          </Alert>
        </div>
          ...
          <div v-if="importResult.errors && importResult.errors.length > 0" class="space-y-1">
            ...
            <div class="max-h-32 overflow-y-auto space-y-1">
              <div 
                ...
                class="text-xs bg-red-50 p-2 rounded border border-red-200"
              >
      ...
      <DialogFooter>
        ...
        <Button 
          @click="submitImport"
          :disabled="!selectedFile || !isValidFileType || form.processing"
        >
          <FileSpreadsheet class="mr-2 h-4 w-4" />
