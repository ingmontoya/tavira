    ...
    <Card>
        ...
        <CardContent v-if="isPreviewVisible">
            ...
            <div v-if="template.variables.length > 0" class="mt-4">
                <div class="text-sm font-medium mb-2">Variables disponibles:</div>
            ...
            <!-- Sample Data Notice -->
            <div v-if="sampleInvoice" class="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                <div class="text-sm text-blue-800">
                    <strong>Nota:</strong> Esta vista previa utiliza datos de ejemplo. 
                    Los valores reales se completarán automáticamente al enviar las facturas.
                </div>
            </div>
        </CardContent>
        ...
        <CardContent v-else>
            <div class="grid grid-cols-2 gap-4 text-sm">
                <div>
                    ...
                    <div class="text-muted-foreground truncate">{{ template.subject }}</div>
                </div>
                <div>
