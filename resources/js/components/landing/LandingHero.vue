    ...
    <section class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 px-6 py-20">
        ...
        <div class="relative z-10 mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
            <div :class="['space-y-8 transition-all duration-1000', isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0']">
                <div class="space-y-6">
                    <div class="inline-flex items-center space-x-2 rounded-full border border-cyan-500/20 bg-white/10 px-4 py-2 text-cyan-300 backdrop-blur-sm">
                ...
                <div class="flex flex-col gap-4 sm:flex-row">
                    <Link
                        ...
                        :href="route('register')"
                        class="group transform rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-3 py-2 sm:px-8 sm:py-4 text-xs sm:text-lg font-semibold text-white shadow-2xl transition-all duration-200 hover:-translate-y-1 hover:from-cyan-600 hover:to-blue-700 hover:shadow-cyan-500/25 flex-shrink-0"
                    >
                    ...
                    <button class="rounded-xl border-2 border-white/30 px-3 py-2 sm:px-8 sm:py-4 text-xs sm:text-lg font-semibold text-white backdrop-blur-sm transition-all duration-200 hover:bg-white/10 flex-shrink-0">
