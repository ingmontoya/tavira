    ...
    <div class="email-wrapper">
        ...
        <div class="header">
            <div class="logo-container">
                <img src="https://tavira.com.co/img/tavira_logo.png" alt="Tavira - Plataforma de Administración" class="logo-image" style="max-height: 120px; width: auto; margin: 0 auto; display: block; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;" border="0">
            </div>
        </div>
