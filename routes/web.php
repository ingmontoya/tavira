...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Conjunto Configuration Management
    Route::resource('conjunto-config', ConjuntoConfigController::class)->except(['create', 'store']);
    Route::get('conjunto-config/create', [ConjuntoConfigController::class, 'create'])
        ->name('conjunto-config.create')
        ->middleware('multiple.conjuntos');
    Route::post('conjunto-config', [ConjuntoConfigController::class, 'store'])
        ->name('conjunto-config.store')
        ->middleware('multiple.conjuntos');
    Route::post('conjunto-config/{conjuntoConfig}/generate-apartments', [ConjuntoConfigController::class, 'generateApartments'])
    ...
    })->name('security.index')->middleware('rate.limit:default');
